...
from config import (
    PAPER_TRADING, INDEX_SECURITY_ID,
    CANDLE_TIMEFRAME_SECONDS
)
from models import Tick, Candle, Signal
from market_feed import MarketFeedHandler, MockMarketFeed
from candle_builder import CandleBuilder
from strategy import AlphaEngine, SignalProcessor
from order_manager import OrderManager
from utils import logger, is_market_hours, time_to_market_open
...
class ScalpingBot:
    ...
    async def _on_signal(self, signal: Signal, spot_price: float, atm_strike: int) -> None:
        ...
        try:
            while self._running:
                try:
                    ...
                    completed_candle = await self.candle_builder.process_tick(tick)
