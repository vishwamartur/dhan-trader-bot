...
class TradingConfig:
    ...
    def validate(self) -> bool:
        ...
        if self.client_id == "YOUR_CLIENT_ID":
            raise ValueError("Please set DHAN_CLIENT_ID environment variable or update config.py")
        if self.access_token == "YOUR_ACCESS_TOKEN":
            raise ValueError("Please set DHAN_ACCESS_TOKEN environment variable or update config.py")
        return True
